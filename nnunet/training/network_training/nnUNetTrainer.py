...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize_optimizer_and_scheduler(self):
        ...
        self.optimizer = torch.optim.Adam(self.network.parameters(), self.initial_lr, weight_decay=self.weight_decay,
                                          amsgrad=True)
        # self.optimizer = RAdam(self.network.parameters(), self.initial_lr, betas=(0.9, 0.999), eps=1e-8, 
        #                        weight_decay=0, degenerated_to_sgd=False)
        self.lr_scheduler = lr_scheduler.ReduceLROnPlateau(self.optimizer, mode='min', factor=0.2, #lr = lr + 0.2*lr
