...
## YLS
def get_moreDA_augmentation_3channel(dataloader_train,dataloader_val,\
                            dataloader_trainV, dataloader_trainA, dataloader_trainN, dataloader_valV, \
                            dataloader_valA, dataloader_valN, patch_size, params=default_3D_augmentation_params,
                            border_val_seg=-1,
    ...
    if use_nondetMultiThreadedAugmenter:
        ...
        batchgenerator_trainV = NonDetMultiThreadedAugmenter(dataloader_trainV, tr_transforms, params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
        batchgenerator_trainA = NonDetMultiThreadedAugmenter(dataloader_trainA, tr_transforms, params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
        batchgenerator_trainN = NonDetMultiThreadedAugmenter(dataloader_trainN, tr_transforms, params.get('num_threads'),
                                                            params.get("num_cached_per_thread"), seeds=seeds_train,
                                                            pin_memory=pin_memory)
    else:
        ...
        batchgenerator_trainV = MultiThreadedAugmenter(dataloader_trainV, tr_transforms, params.get('num_threads'),
                                                      params.get("num_cached_per_thread"),
                                                      seeds=seeds_train, pin_memory=pin_memory)
        batchgenerator_trainA = MultiThreadedAugmenter(dataloader_trainA, tr_transforms, params.get('num_threads'),
                                                      params.get("num_cached_per_thread"),
                                                      seeds=seeds_train, pin_memory=pin_memory)
        batchgenerator_trainN = MultiThreadedAugmenter(dataloader_trainN, tr_transforms, params.get('num_threads'),
                                                      params.get("num_cached_per_thread"),
                                                      seeds=seeds_train, pin_memory=pin_memory)
    ...
    if use_nondetMultiThreadedAugmenter:
        ...
        batchgenerator_valV = NonDetMultiThreadedAugmenter(dataloader_valV, val_transforms,
                                                          max(params.get('num_threads') // 2, 1),
                                                          params.get("num_cached_per_thread"),
                                                          seeds=seeds_val, pin_memory=pin_memory)
        batchgenerator_valA = NonDetMultiThreadedAugmenter(dataloader_valA, val_transforms,
                                                          max(params.get('num_threads') // 2, 1),
                                                          params.get("num_cached_per_thread"),
                                                          seeds=seeds_val, pin_memory=pin_memory)
        batchgenerator_valN = NonDetMultiThreadedAugmenter(dataloader_valN, val_transforms,
                                                          max(params.get('num_threads') // 2, 1),
                                                          params.get("num_cached_per_thread"),
                                                          seeds=seeds_val, pin_memory=pin_memory)                                                     
    else:
        batchgenerator_val = MultiThreadedAugmenter(dataloader_val, val_transforms,
                                                    ...
                                                    params.get("num_cached_per_thread"),
                                                    seeds=seeds_val, pin_memory=pin_memory)
        batchgenerator_valV = MultiThreadedAugmenter(dataloader_valV, val_transforms,
                                                    max(params.get('num_threads') // 2, 1),
                                                    params.get("num_cached_per_thread"),
                                                    seeds=seeds_val, pin_memory=pin_memory)
        batchgenerator_valA = MultiThreadedAugmenter(dataloader_valA, val_transforms,
                                                    max(params.get('num_threads') // 2, 1),
                                                    params.get("num_cached_per_thread"),
                                                    seeds=seeds_val, pin_memory=pin_memory)
        batchgenerator_valN = MultiThreadedAugmenter(dataloader_valN, val_transforms,
                                                    max(params.get('num_threads') // 2, 1),
                                                    params.get("num_cached_per_thread"),
                                                    seeds=seeds_val, pin_memory=pin_memory)
    ...
    return batchgenerator_train, batchgenerator_val,\
           batchgenerator_trainV, batchgenerator_trainA, batchgenerator_trainN, \
           batchgenerator_valV,batchgenerator_valA, batchgenerator_valN   ## YLS
