...
from nnunet.inference.segmentation_export_CAM import save_segmentation_nifti_from_softmax, save_segmentation_nifti, patch_cam_cal
...
# from nnunet.training.network_training.nnUNetTrainer_visual import nnUNetTrainer
...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
    ...
    for preprocessed in preprocessing:
        ...
        ret = trainer.predict_preprocessed_data_return_seg_and_softmax(
            d, do_mirroring=do_tta, mirror_axes=trainer.data_aug_params['mirror_axes'], use_sliding_window=True,
            step_size=step_size, use_gaussian=True, all_in_gpu=all_in_gpu,
            mixed_precision=mixed_precision)
        softmax, cam = ret[1], ret[2]
        ...
        if transpose_forward is not None:
            ...
            cam = cam.transpose([0] + [i + 1 for i in transpose_backward])
        ...
        results.append(pool.starmap_async(save_segmentation_nifti_from_softmax,
                                          ((softmax, cam, output_filename, dct, interpolation_order, region_class_order,
                                            None, None,
